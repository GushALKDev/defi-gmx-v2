...
contract Long {
        ...
        returns (bytes32 key)
    {
        ...
        uint256 sizeDeltaUsd = wethAmount * ethPrice * leverage * 1e4; // 1e8 * 1e18 * 1e0 * 1e4 = 1e30

        // increase order:
        // - long: executionPrice should be smaller than acceptablePrice
        // - short: executionPrice should be larger than acceptablePrice
        uint256 acceptablePrice = ethPrice * 1e4 * 101 / 100;  // acceptablePrice requires 12 decimals -> with 1% slippage
